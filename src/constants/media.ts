...
export const posts: Post[] = [
  {
    ...
    date: null,
    title:
      "Rythmes Africains et dialogues musicaux : Zied Zouari enchante Hammamet lors de la 58ème Édition du Festival ",
    excerpt:
      "La soirée du 11 juillet 2024 a offert au public du centre culturel international de Hammamet une expérience musicale inoubliable.Ils ont été emportés par une vague de rythmes et de sonorités, orchestrés par le talentueux musicien tunisien Zied Zouari dans sa nouvelle création “Made in Africa”.",
  ...
  },
  {
    ...
    date: "16/09/2024",
    title:
      "La tournée Japonaise du groupe “Duplessy et les violons du Monde” : le violoniste Tunisien Zied Zouari, resplendit sur la scène Internationale",
    excerpt:
      "Le 15 septembre 2024, le groupe Duplessy et les violons du Monde a donné le coup d’envoi de sa tournée japonaise au Forest Hall d’Aichi, marquant le début d’une série de 10 concerts dédiés à la promotion de son album “The Road with you “, avec une sortie prévue pour le 29 janvier 2025 à La Cigale, Paris.",
    category: "Musicien.tn",
  ...
  },
  {
    ...
    date: "2024/07/13",
    title:
      "Made in Africa est une peinture musicale africaine dirigée par le Tunisien Ziad Zouari",
    excerpt:
  ...
  },
  {
    ...
    date: "24/07/2019",
    title:
      "FIC 2019: Soirée d’expérimentation musicale avec Zied Zouari, Nidhal Yahiaoui et Lina Ben Ali",
    excerpt:
  ...
  },
  {
    ...
    date: "17/10/2024",
    title:
      "«Le concert des continents : Cordes en Harmonie» à Yasmine Hammamet : Une rencontre musicale au carrefour des cultures",
    excerpt:
  ...
  },
  {
    ...
    excerpt:
      "Le directeur artistique du spectacle de clôture du Festival arabe de la radio et de la télévision musicale, Zied Zouari, nous parle du spectacle Ruh Al-Arab, de la création de l'Orchestre symphonique arabe et de nombreux autres détails.",
    category: "BinElBinin",
    link: "(1) Facebook",
  ...
  },
  {
    ...
    date: "15/06/2023",
    title:
      "L'émission Marassi : Bab Al-Diwan, réunit les musiciens Zied Zouari (violon) et Ghassan Fendri (guitare).",
    excerpt:
      "L'épisode d'aujourd'hui de l'émission Marassi est consacré à la découverte d'un projet musical venant de la ville historique de Sfax, en Tunisie, intitulé Bab Al-Diwan. Ce projet réunit les musiciens Zied Zouari (violon) et Ghassan Fendri (guitare)...",
